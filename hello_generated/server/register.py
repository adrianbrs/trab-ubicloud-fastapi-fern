...
from .resources.utils.service.service import AbstractUtilsService
...
def register(
    ...
    *,
    ...
    _app.include_router(__register_service(utils), dependencies=dependencies)
